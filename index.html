				...
				<div class="row">
					<div class="col-lg-7">
						<div class="banner_content">
							...
							<h2 class="text-uppercase">Saya Putri Nanda Aling Dianriana</h2>
							<h5 class="text-uppercase">Videographer </h5>
							<div class="d-flex align-items-center">
								<a class="primary_btn" href="#"><span>Rekrut Saya</span></a>
								<a class="primary_btn tr-bg" href="#"><span>Ambil CV</span></a>
							</div>
						</div>
					</div>
					<div class="col-lg-5">
			...
			<div class="row justify-content-start align-items-center">
				...
				<div class="offset-lg-1 col-lg-5">
					<div class="main_title text-left">
						...
						<a class="primary_btn" href="#"><span>Unduh CV</span></a>
					</div>
				</div>
			</div>
		</div>
		...
		<div class="container">
			<div class="row">
				<div class="col-lg-12">
					<div class="main_title text-left">
						<h2>Projek <br>
							Beberapa projek yang saya buat </h2>
					</div>
				</div>
			</div>
				...
				<div class="row portfolio-grid justify-content-center">
					<div class="col-lg-4 col-md-6 all latest">
						<div class="portfolio_box">
							...
							<div class="short_info">
								<h4><a href="portfolio-details.html">"Sesal"</a></h4>
								<p>Film Pendek, Abhitama</p>
							</div>
						</div>
					</div>
					<div class="col-lg-4 col-md-6 all popular">
						<div class="portfolio_box">
							...
							<div class="short_info">
								<h4><a href="portfolio-details.html"> "Jamu Tradisinonal Gumawang, Kebumen"</a></h4>
								<p>Company Profile, Abhitama</p>
							</div>
						</div>
					</div>
					<div class="col-lg-4 col-md-6 all latest">
						<div class="portfolio_box">
							...
							<div class="short_info">
								<h4><a href="portfolio-details.html">"Puisi Hati"</a></h4>
								<p>Film Pendek, Abhitama</p>
							</div>
						</div>
					</div>
					<div class="col-lg-4 col-md-6 all popular">
						<div class="portfolio_box">
							...
							<div class="short_info">
								<h4><a href="portfolio-details.html">Ki "Bumidirjo"</a></h4>
								<p>Film pendek, Abhitama</p>
							</div>
						</div>
					</div>
					...
					<div class="subscription_box text-center">
						...
						<div class="subcribe-form" id="mc_embed_signup">
							<form target="_blank" novalidate="true" action="https://spondonit.us12.list-manage.com/subscribe/post?u=1462626880ade1ac87bd9c93a&amp;id=92a4423d01" method="get" class="subscription relative">
								...
								<button class="primary-btn hover d-inline">Mulai</button>
								<div class="info"></div>
							</form>
						</div>
					</div>
...
Copyright &copy;<script>document.write(new Date().getFullYear());</script> All rights reserved | Dibuat dengan <i class="fa fa-heart-o" aria-hidden="true"></i> by <a href="https://colorlib.com" target="_blank">Putri Nanda Aling Dianriana</a>
